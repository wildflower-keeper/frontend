    ...
    return (
        <div className="flex items-center bg-neutral-300 p-3 gap-2 rounded-md mb-5">
            ...
            <div className="flex flex-col gap-1">
                <h1 className="text-sm">{title || "제목을 입력해주세요."} <span className="text-xs text-neutral-500">지금</span></h1>
                <p className="text-sm text-neutral-500 max-w-[270px]">{content || "내용을 입력해주세요."}</p>
            </div>
        </div>
    )
}
